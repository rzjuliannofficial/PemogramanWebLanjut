...
<div class="form-container">
    <div class="page-header">
        ...
        <p>Buat pengguna baru untuk sistem</p>
    </div>
    ...
    <div class="form-wrapper">
        <form action="/user/tambah_simpan" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" placeholder="Masukkan username (misal: admin01)" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="level_id" name="level_id" placeholder="Masukkan ID level (contoh: 1, 2, 3)" min="1" required>
            </div>
